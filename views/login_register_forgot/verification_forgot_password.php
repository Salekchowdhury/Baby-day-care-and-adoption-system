...
<div class="row">
    ...
    border-top-right-radius: 45px; border: 3px solid">
                    ...
                    <form  action="../../views/process/verify.php" method="post" style=" background-color: rgba(21,3,71,0.86);display: inline-block;margin-left: 10px;margin-top: 106px;border: 2px solid;border-radius: 13px;padding: 84px; margin: auto">
                        <?php
                        ...
                        ?>
                        <h4 style="color: #00cd5a">Check Your Email</h4>
                     ...
                     <input type="hidden"  name="email" value="<?php echo $email?>">
                        ...
                        <button type="submit" class="button btn btn-primary btn-outline-success" name="confirmForgotPassword">Confirm</button>
                        <br>
                        <br>
                        <div class="row">
                            <div class="col-sm-12 btn-group">
                                <a class="btn btn-primary btn-outline-success  btn-group" href="login.php" >Login</a>
