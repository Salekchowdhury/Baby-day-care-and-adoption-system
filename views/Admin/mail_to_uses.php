...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        if(isset($_GET['email_id'])){
            $userinfo = $datamanipulation->showFosterProfile($_GET['email_id']);
                        ...
                        <div class="card-body">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text"  required disabled class="form-control"  value="<?php echo $userinfo->name?>">
                                    <input type="hidden" name="name"   value="<?php echo $name?>">
                                </div>
                                <div class="form-group ">
                                    <label class="form-control-label">Gmail:</label>
                                    <input type="email" required   disabled class="form-control"  value="<?php echo $userinfo->email?>">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success btn-rounded" required  name="message_to_foster" value="Send Message">
                                    </div>
                                </div>
                            </fieldset>
                        </div>
