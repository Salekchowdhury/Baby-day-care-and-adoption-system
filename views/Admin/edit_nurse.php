                    ...
                    <div class="card card-user" style="background-color: rgba(17,4,71,0.86) ">
                        <div class="card-header">
                            ...
                            if (isset($_GET["edit_nurse"])){
                                $nurse_id = $_GET["edit_nurse"];
                                $data=$datamanipulation->showNurseById($nurse_id);
                            }
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"  class="form-control" name="id" value="<?php echo $nurse_id?>" placeholder="Name">
                                            <input type="text" required class="form-control" name="name" value="<?php echo $data->name?>" placeholder="Name">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" required class="form-control" name="email" placeholder="Email" value="<?php echo $data->email?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control" cols="5" rows="5" name="address" value="" placeholder="Home Address"><?php echo $data->address?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pl-1">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required class="form-control" name="phone" value="<?php echo $data->phone?>" placeholder="Phone Number">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
<!--                                            <label style="color: white">Image</label>-->
                                            <img src="<?php echo $data->image?>" width="110" height="110">
                                            <input class="text-light mt-2" type="file" name="photo" accept="image/x-png,image/gif,image/jpeg">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="update w-50">
                                        <button type="submit" name="edit_nurse" class="btn btn-success btn-round">EDIT</button>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-md-8" style="border: 2px  royalblue; margin-top: 15px;border-radius: 20px; height:480px">
                    <table id="parvez1" class="table">
                        ...
                        foreach ($lists as $list){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../process/admin_process.php?edit_nurse=<?php echo $list->id?>"title="Edit" class="btn btn-primary btn-outline-success text-light"> EDIT</a>
