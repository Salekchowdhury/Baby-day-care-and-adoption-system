        ...
        <section class="content-header">
            ...
            <div class="col-12 text-light">
                <div class="card text-light" style="background-color: rgba(17,4,71,0.86)">
                    ...
                    <div class="card-body">
                        <h3 style="color: white">Pending Account</h3>
                        <?php
                        ...
                        <table id="sohag1" class="table table-bordered table-hover ">
                            ...
                            <tbody>
                            <?php
                            $lists=$datamanipulation->showAllDeactiveUsersAccount();
                            ...
                            if($lists){
                                foreach ($lists as $list) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="user_profile.php?view_user=<?php echo $list->user_id?>"title="Details" <i class="btn btn-success far fa-eye"></i> VIEW</a>
                                            <a href="../process/admin_process.php?confirm_id=<?php echo $list->user_id?>"title="Confirm" <i class="btn btn-success far fa-check-circle"></i> CONFIRM</a>
                                        </td>
                                    </tr>
                                    <?php
                                    $s++;
