                ...
                <div class="card card-plain">
                    ...
                    <div class="card-body" style="background-color: ">
                        <div class="scroll-content">
                            ...
                            ?>
                            <h2>Total Payment (<?php echo $totalAmount?>)</h2>
                                        ...
                                        <td>
                                            ...
                                            if($list->status == 'seen'){
                                              ?>
                                                ...
                                                ?>
                                                <a  href="../process/admin_process.php?payment_id=<?php echo $list->payment_id ?>"title="Confirm"  <i class="btn btn-success far fa-check-circle"></i> CONFIRM</a>
                                                <?php
                                            }
                                            ?>
            ...
            <div class="col-12">
                ...
                <div class="card card-plain">
                    ...
                    <div class="card-body" style="background-color: ">
                        <div class="scroll-content">
                            <?php
                            $CountAmount=$datamanipulation->CountTotalDonation();

                            $totalAmount=$CountAmount->total;
                            ?>
                            <h2>Total Donation (<?php echo $totalAmount?>)</h2>
                            <table id="pro1" class="table">
                                ...
                                $lists=$datamanipulation->showAllDonation();
                                $s=1;
                                foreach ($lists as $list){
                                    $date=$list->date;
                                    $dateArray = explode("-",$date);
