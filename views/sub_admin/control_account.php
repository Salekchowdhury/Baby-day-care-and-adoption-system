        ...
        <section class="content-header">
            ...
            <div class="col-12">
                <div class="card text-light" style="background-color: rgba(17,4,71,0.86)">
                    ...
                    <div class="card-body">
                        <h3 style="color: white">Control Account</h3>
                        <?php
                        ...
                        <table id="sohag1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                               <?php
                               $lists=$datamanipulation->showAllUsersAccount();
                               ...
                               if($lists){
                                  foreach ($lists as $list) {
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <a style="color: white" href="../process/admin_process.php?delete_id=<?php echo $list->user_id?>"title="Delete" class="btn  btn-secondary btn-outline-danger"><i class="fas fa-trash" aria-hidden="true"></i> DELETE</a>
                                          </td>
                                      </tr>
                                      <?php
                                      $s++;
