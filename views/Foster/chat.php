            ...
            success: function(data)
            {
              ...
              for(var i =0; i<data.length;i++){
                ...
                if((data[i].message_to) !=null){
                  htmlstring += "<div class=\"direct-chat-msg bg-dark rounded my-1 text-white mr-2 \">\n" +
                    "                        <div class=\"direct-chat-infos p-1 clearfix\">\n" +
//                    "                            <span class=\"direct-chat-name float-left text-success\">"+ data[i].sellers_name + "</span>\n" +
                ...
                if((data[i].message_from) !=null){
                  htmlstring +="<div class=\"direct-chat-msg right  bg-secondary  rounded my-1 text-black mr-2 \">\n" +
                    "                        <div class=\"direct-chat-infos p-1 clearfix\">\n" +
            ...
            success: function(data)
            {
              ...
              $.ajax({
                ...
                success: function(data)
                {
                  ...
                  for(var i =0; i<data.length;i++){
                    if((data[i].message_to) !=null){
                      htmlstring += "<div class=\"direct-chat-msg text-white \">\n" +
...
//                        "                        <img class=\"direct-chat-img\"  src=\"../../assets/img/ok-2B.jpg\"  alt=\"Message User Image\">\n" +
                    ...
                    if((data[i].message_from) !=null){
                      htmlstring +="<div class=\"direct-chat-msg right text-white\">\n" +
                        "                        <div class=\"direct-chat-infos clearfix\">\n" +
