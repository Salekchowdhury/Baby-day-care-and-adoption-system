                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal" action="../process/baby_care_process.php" method="post" enctype="multipart/form-data" >
                                    <div class="row">
                                        ...
                                        <div class="col-11 ml-3" >
                                            ...
                                            <div class="form-group row mt-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="name" required class="form-control" value="" style="border-radius: 25px">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label" style="color: white">Age:</label><span class=""> <b style="font-size: 28px;color: white"></b></span>
                                                <div class="col-sm-10">
                                                    <input type="number" name="age" required class="form-control" value="" style="border-radius: 25px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select required name="gender" class="form-control form-control-lg" id="exampleFormControlSelect2" style="border-radius: 25px">
                                                        <option class="text-dark" value="">Select Gender</option>
                                            ...
                                            <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label" style="color: white">Admit Date:</label><span class=""> <b style="font-size: 28px;color: white"></b></span>
                                                <div class="col-sm-10">
                                                    <input type="date"  required class="form-control" name="admit_date" value="" style="border-radius: 25px">
                                                </div>
                                            </div>

                                             <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label" style="color: white">Baby Image:</label><span class=""> <b style="font-size: 28px;color: white"></b></span>
                                                <div class="col-sm-10">
                                    ...
                                    <input type="submit" class="btn btn-success btn-rounded w-100  mb-2"  name="register_baby" value="Submit" style="margin-top: 15px;font-size: 21px; text-align: center;border: 1px solid;" >
