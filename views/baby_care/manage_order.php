                    ...
                    <div class="card card-plain">
                        ...
                        <div class="card-body">
                            <table id="" class="table table-bordered table-striped table-hover">
                                <thead class="" style="background-color: #21025d ;color:white">
                                <tr>
                                    <th>SL#</th>
                                    <th>Product Name</th>
                                    <th>Seller Name</th>
                                ...
                                if ($list){
                                    foreach ($list as $lists){
                                        $buyerData = $datamanipulation->showStaffProfile($lists->seller_id);
                                        ?>
                                        <tr>
                                            <td><?php echo $s++ ?></td>
                                            ...
                                            if($lists->confirm_status=='yes'){
                                                ?>
                                                <td>
                                                    <span class="btn-sm btn-success" style="font-size: 10px; margin-right: 2px">Accepted  </span><span style="font-size: 14px;color: #9d10ff"> (<?php echo' Delivery: '. $lists->confirm_date?>)</span>
                                                ...
                                                ?>
                                                <td>
                                                    <span class="btn-sm btn-danger" style="font-size: 10px; margin-right: 3px">Pending</span><a href="../process/baby_care_process.php?seller_user_id=<?php echo  $lists->cart_id ?>"  <i class="  btn btn-success btn-outline-primary fas fa-trash-alt" aria-hidden="true" style="background-image: linear-gradient(#590c70, #bfa512)"></i> Delete</a>
                                                    <!--<a href="../process/data_process.php?seller_user_id=<?php /*echo  $lists->no */?>"   ><i class="disabled fas fa-trash"></i> Delete</a>-->
                                                </td>
                                                <?php
                                            }
