                            ...
                            <div class="card-body" style="background-color: ">
                                <div class="scroll-content">
                                    <table class="table">
                                        ...
                                        <?php
                                        $lists=$datamanipulation->showAllRegisterBabyById($user_id);
                                        $s=1;
                                        foreach ($lists as $list){
                                            $date=$list->admit_date;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="baby_details.php?baby_id=<?php echo $list->id?>" style="color: white" class="btn bg-success btn-rounded btn-outline-success attrValue show-chat-box-click" ><i class="fas fa-eye"></i> DETAILS</a>

                                                    <?php
                                                    if($list->status == 'yes'){
                                                        ?>
                                                        <span  class="text-success" <i class="btn btn-success far fa-check-circle"></i> Accepted</span>

                                                        <?php
                                                    }else{
                                                        ?>
                                                        <span  class="text-danger" <i class="btn btn-success far fa-check-circle"></i> Pending</span>
                                                        <?php
                                                    }
